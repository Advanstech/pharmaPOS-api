...
class EmailTemplates {
    static staffInvitation(staffName, email, temporaryPassword, invitedBy, branchName) {
        return {
...
<body>
    ...
    static salesReceipt(customerName, customerEmail, saleDetails) {
...
<body>
    ...
    static customerWelcome(customerName, customerCode, branchName) {
        return {
...
<body>
    ...
    static passwordReset(staffName, resetToken, requestedBy = null) {
...
EmailTemplates.baseUrl = process.env.WEB_APP_URL || 'https://pharmapos.com';
